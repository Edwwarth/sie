<?php
$cuestionario = new Cuestionario($_GET['idCuestionario']); 
$cuestionario -> select();
$error = 0;
...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Esquema of Cuestionario: <em><?php echo $cuestionario -> getRespuesta() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					...
					if(isset($_GET['order']) && isset($_GET['dir'])) {
						$esquemas = $esquema -> selectAllByCuestionarioOrder($_GET['order'], $_GET['dir']);
					} else {

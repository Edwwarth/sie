...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Esquema of Respuesta: <em><?php echo $respuesta -> getTipo() . " " . $respuesta -> getValor() ?></em></h4>
		</div>
		<div class="card-body">
		<?php if(isset($_GET['action']) && $_GET['action']=="delete"){ ?>
			...
			<table class="table table-striped table-hover">
				<thead>
					...
					<?php
					$esquema = new Esquema("", "", $_GET['idRespuesta'], "");
					if(isset($_GET['order']) && isset($_GET['dir'])) {
						$esquemas = $esquema -> selectAllByRespuestaOrder($_GET['order'], $_GET['dir']);
					} else {

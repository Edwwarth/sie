...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Get All Respuesta</h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/respuesta/selectAllRespuesta.php") ?>&order=respuesta&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/respuesta/selectAllRespuesta.php") ?>&order=respuesta&dir=desc'>
						...
						<?php if(isset($_GET['order']) && isset($_GET['dir']) && $_GET['order']=="acierto" && $_GET['dir']=="asc") { ?>
							<span class='oi oi-caret-top'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/respuesta/selectAllRespuesta.php") ?>&order=acierto&dir=asc'>
							<span class='oi oi-sort-ascending' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' ></span></a>
						<?php } ?>
						<?php if(isset($_GET['order']) && isset($_GET['dir']) && $_GET['order']=="acierto" && $_GET['dir']=="desc") { ?>
							<span class='oi oi-caret-bottom'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/respuesta/selectAllRespuesta.php") ?>&order=acierto&dir=desc'>
							<span class='oi oi-sort-descending' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' ></span></a>
						<?php } ?>
						</th>
						<th>Pregunta</th>
					...
					if(isset($_GET['order']) && isset($_GET['dir'])) {
						$respuestas = $respuesta -> selectAllOrder($_GET['order'], $_GET['dir']);
					} else {
						$respuestas = $respuesta -> selectAll();
					}
					$counterPregunta = 1;

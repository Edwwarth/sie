...
if(isset($_POST['update'])){
	$updateAdministrator = new Administrator($_SESSION['id'], $name, $lastName, $email, "", "", $phone, $mobile);
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/administrator/updateProfileAdministrator.php") ?>" class="bootstrap-form needs-validation" novalidate  >

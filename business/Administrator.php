...
class Administrator {
	...
	function Administrator($pIdAdministrator = "", $pName = "", $pLastName = "", $pEmail = "", $pPassword = "", $pPicture = "", $pPhone = "", $pMobile = ""){
		$this -> idAdministrator = $pIdAdministrator;
		$this -> name = $pName;
		$this -> lastName = $pLastName;
		$this -> email = $pEmail;
		...
		$this -> phone = $pPhone;
		$this -> mobile = $pMobile;
		$this -> administratorDAO = new AdministratorDAO($this -> idAdministrator, $this -> name, $this -> lastName, $this -> email, $this -> password, $this -> picture, $this -> phone, $this -> mobile);
	...
	function selectAll(){
		...
		while ($result = $this -> connection -> fetchRow()){
			array_push($administrators, new Administrator($result[0], $result[1], $result[2], $result[3], $result[4], $result[5], $result[6], $result[7]));
		}
		$this -> connection -> close();
